		...
		options: [
			{
				...
				type: 'string',
				default: '',
				description: 'Search customers by city (LIKE match)',
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Search customers by name (LIKE match)',
			},
			{
				displayName: 'Customer Number',
				name: 'customernumber',
				type: 'string',
				default: '',
				description: 'Search customers by customer number (LIKE match)',
			},
			{
				displayName: 'Email',
				name: 'email',
				...
				default: '',
				description: 'Search customers by email (LIKE match)',
			},
			{
				displayName: 'Filter',
				name: 'filter',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Search customers by Global Location Number (LIKE match)',
			},
			{
				displayName: 'GLN Delivery',
				name: 'glndelivery',
				type: 'string',
				default: '',
				description: 'Search customers by delivery GLN (LIKE match)',
			},
			{
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Search customers by organisation number (LIKE match)',
			},
			{
				displayName: 'Phone',
				name: 'phone1',
				type: 'string',
				default: '',
				description: 'Search customers by phone number (LIKE match)',
			},
			{
				displayName: 'Sort By',
				name: 'sortby',
			...
			},
			{
				...
				type: 'string',
				default: '',
				description: 'Search customers by zip/postal code (LIKE match)',
			},
		],
	},
